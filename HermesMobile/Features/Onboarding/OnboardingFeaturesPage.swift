...
struct OnboardingFeaturesPage: View {
    ...
    private let features: [(icon: String, color: Color, title: String, subtitle: String)] = [
        ("bubble.left.and.bubble.right.fill", Color(red: 1.0, green: 0.74, blue: 0.10), String(localized: "Chat with Goku from iPhone"), String(localized: "Drive conversations from anywhere on your tailnet.")),
        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: dynamicTypeSize.isAccessibilitySize ? 28 : 36) {
                VStack(spacing: 10) {
                    ...
                    Text("Goku, reachable from iPhone over Tailscale.")
                        .font(.subheadline)
